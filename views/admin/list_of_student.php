        ...
        <div class="section-body">
              ...
              <div class="card-header">
                 <h4></h4>
                  <div class="card-header-action">
                      <a href="list_of_student_add.php?cid=<?php echo $class_id ?>" class="btn btn-success btn-sm">Add Students</a>
                      <a href="class.php" href="#" class="btn btn-danger btn-sm">GO BACK</a>
                   </div>
              </div>
            ...
            <div class="card-body">
                    <div class="table-responsive">
                      ...
                      WHERE studentlist.classID = '$class_id'
                      ";
                      ...
                      while($rowClassListStudent = mysqli_fetch_assoc($resultClassListStudent)) {
                        ...
                        <tr>
                          ...
                          <td>
                           <!--  <a href="#list_of_student_update.php?uid=<?php //echo $studentlist_id ?>" class="btn btn-primary btn-sm text-white">UPDATE</a>
                            --> <a href="../../backend/studentlist.php?remove=<?php echo $studentlist_id ?>&cid=<?php echo $class_id?>" class="btn btn-danger btn-sm text-white">REMOVE</a>
                          </td>
                        </tr>
